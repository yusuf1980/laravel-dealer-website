...
//use App\Functions\Model;

class Stat extends Model
{
    protected $table = 'stats';

    protected $fillable = ['trackable_id','trackable_type','one_day_stats','seven_days_stats','thirty_days_stats','all_time_stats','raw_stats','created_at'];
