...
<?php
    $field['options'] = ['page_link' => trans('backpack::crud.page_link'), 'internal_link' => trans('backpack::crud.internal_link'), 'external_link' => trans('backpack::crud.external_link'),'product'=>'Produk'];
...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <div class="col-sm-9">
        <!-- external link input -->
          ...
          <div class="page_or_link_value <?php if (!isset($entry) || $entry->type != 'product') {
                echo 'hidden';
} ?>" id="product">
